...
<form method="post" action="">
	...
	while($rs = mysqli_fetch_array($qsql))
	{
		...
		echo "<img src='imgfaculty/" . $rsfaculty['faculty_img'] . "' style='width: 100px; height: 100px;' align='left' >	";
		echo "</td>";
		echo "<td>";
		if($rs['faculty_id'] != 0)
		{
			echo "&nbsp;<b>" . $rsfaculty['faculty_name'] . "</b><br> &nbsp;" . $rsfaculty['faculty_designation'] . "";
		}
		echo "</td>";
		echo "<td>" . $rs['feedbacktopic_detail'];
		echo "</td>";
