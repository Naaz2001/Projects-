...
if(isset($_POST['submit']))
{
	...
	{
		$sql ="UPDATE student SET studentname='".$_POST['studentname']."',rollno='".$_POST['rollno']."',`dateofbirth`='".$_POST['dateofbirth']."',`password`='".$_POST['password']."',`course_id`='".$_POST['studentclass']."',`section`='".$_POST['section']."',status='".$_POST['status']."'  WHERE rollno='".$_GET['editid']."'";
...
//####Point System Ends Here####
	...
	{
		$sql ="INSERT INTO student SET studentname='".$_POST['studentname']."',rollno='".$_POST['rollno']."',`dateofbirth`='".$_POST['dateofbirth']."',`password`='".$_POST['password']."',`course_id`='".$_POST['studentclass']."',`section`='".$_POST['section']."',status='".$_POST['status']."',type='".$_POST['type']."'   ";
		$qsql = mysqli_query($con,$sql);
			echo mysqli_error($con);
		if(mysqli_affected_rows($con) ==1)
		{
...
if(isset($_GET['editid']))
{
	...
	$sqledit ="SELECT * FROM student WHERE rollno='".$_GET['editid']."'";
