...
?>			
			<tr>
				<td>
					...
					if($rsqz['selectedanswer']=='Strongly Agree')
					{
					$Strongly_Agree= $Strongly_Agree + 1;
					}
					
					if($rsqz['selectedanswer']=='Uncertain')
					{
					$Uncertain= $Uncertain + 1;
					}
					
					if($rsqz['selectedanswer']=='Agree')
					{
					$Agree= $Agree + 1;
					}
					
					if($rsqz['selectedanswer']=='Disagree')
					{
					$Disagree= $Disagree + 1;
					}
					
					if($rsqz['selectedanswer']=='Strongly_Disagree')
					{
...
<body>
  ...
  <script>
  var data = [{
  values: [<?php echo $Strongly_Agree; ?>, <?php echo $Uncertain; ?>, <?php echo $Agree; ?>, <?php echo $Disagree; ?>, <?php echo $Strongly_Disagree; ?>],
  labels: ['Strongly_Agree', 'Uncertain', 'Agree', 'Disagree', 'Strongly_Disagree'],
  type: 'pie'
}];
